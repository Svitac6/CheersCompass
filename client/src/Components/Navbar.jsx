...
const Navbar = () => {
    ...
    const getLinkClass = (path) => (
        location.pathname === path
            ? 'bg-yellow-700 text-white px-3 py-2 rounded-md text-sm font-medium'
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16">
                    <div className="flex items-center">
                        <div className="flex ">
                            <img width="30" src={icone} alt="Icon" />
                        </div>
                        <div className="hidden md:ml-6 md:flex md:space-x-8 text-white">
                    ...
                    <div className="flex items-center">
                        {isLoggedIn ? (
                            ...
                            <Link to="/login" className="bg-yellow-700 text-white px-3 py-2 rounded-md text-sm font-medium">Login</Link>
                        )}
                    </div>
                    <div className="-mr-2 flex md:hidden">
                        <button onClick={toggleNavMenu} className="inline-flex items-center justify-center p-2 rounded-md text-white hover:bg-yellow-700 focus:outline-none focus:bg-yellow-700 focus:text-white">
